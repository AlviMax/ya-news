...
class TestRoutes(TestCase):
    ...
    def test_pages_availability(self):
        ...
        urls = (
            # Путь для главной страницы не принимает никаких позиционных
            # аргументов, поэтому вторым параметром ставим None.
            ('news:home', None),
            # Путь для страницы новости принимает в качестве позиционного
            # аргумента id записи; передаём его в кортеже.
    ...
    # Группа тестов по пунктам 3, 5 плана
    def test_availability_for_comment_edit_and_delete(self):
        ...
        - Читатель не может зайти на страницу редактирования
          чужого комментария.
